...
public class Rectangle extends Shape{
	...
	public String toString() {
		return "Upper left point: " + upperLeftPoint.toString() + ", width = " + width + 
	", height = " + height;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof Rectangle) {
			...
			if(upperLeftPoint.equals(secondRect.upperLeftPoint) && width == 
	secondRect.width && height == secondRect.height) {
				return true;
			}
		}
		return false;
